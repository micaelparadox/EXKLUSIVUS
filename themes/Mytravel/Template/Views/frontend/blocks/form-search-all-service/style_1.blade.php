<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2" style="background: none;">
    <video autoplay muted loop poster="{{$bg_image_url}}" style="position: absolute; left: 0; top: 0; min-width: 100%; min-height: 100%; width: 100%; height: 100%; object-fit: cover; z-index: -1;">
        <source src="{{$bg_image_url}}" type="video/mp4">
    </video>
