<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2" style="background: none;">
    <video autoplay muted loop poster="<?php echo e($bg_image_url); ?>" style="position: absolute; left: 0; top: 0; min-width: 100%; min-height: 100%; width: 100%; height: 100%; object-fit: cover; z-index: -1;">
        <source src="<?php echo e($bg_image_url); ?>" type="video/mp4">
    </video>
    <div class="container space-2 space-top-xl-4">
        ...
        <?php if(empty($hide_form_search)): ?>
            <div class="mb-lg-n1 position-relative" style="z-index: 1;">
...
<?php /**PATH C:\xampp\htdocs\app\themes/Mytravel/Template/Views/frontend/blocks/form-search-all-service/style_1.blade.php ENDPATH**/ ?>