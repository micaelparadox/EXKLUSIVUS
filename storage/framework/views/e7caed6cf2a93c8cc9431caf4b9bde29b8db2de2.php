                ...
                <div class="content">
                    <div class="header-left">
                        <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo navbar-brand u-header__navbar-brand-default u-header__navbar-brand-center u-header__navbar-brand-text-white mr-0 mr-xl-5">
                            ...
                            <?php if($logo_id = setting_item("logo_id")): ?>
                                <?php $logo = get_file_url($logo_id,'full') ?>
                                <img style="max-width: 64px" src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item('site_title')); ?>">
                            <?php else: ?>
                            <span class="u-header__navbar-brand-text"><?php echo e(setting_item_with_lang("logo_text")); ?></span>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\app\themes/Mytravel/Layout/parts/header.blade.php ENDPATH**/ ?>