...
class MediaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Pass the allowed file formats to the uploadFile method
            // $allowed_formats = 'jpg,jpeg,png,gif,bmp,docx,mp4,webm,ogg';
            //
            $fileObj = $this->uploadFile($request, $fileName, $file_type === 'video' ? 'video' : 'default', $request->input('folder_id'));
