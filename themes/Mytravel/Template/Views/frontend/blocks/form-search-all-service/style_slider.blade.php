        ...
        <div class="owl-carousel">
            @foreach($list_slider as $item)
                ...
                <div class="item-video" style="position: relative;">
                    <video autoplay muted loop poster="{{$img}}" style="position: absolute; z-index: -1; top: 0; left: 0; width: 100%; height: 100%;">
                        <source src="{{ get_file_url($item['bg_video'],'full') }}" type="video/mp4">
                    </video>
                    <div class="pb-10">
