<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2" style="background-image: url('<?php echo e($bg_image_url); ?>') !important;">
    <video autoplay muted loop poster="<?php echo e($bg_image_url); ?>" style="position: fixed; z-index: -1; top: 0; left: 0; width: 100%; height: 100%;">
        <source src="<?php echo e($bg_video_url); ?>" type="video/mp4">
    </video>
...
<?php /**PATH C:\xampp\htdocs\app\themes/Mytravel/Template/Views/frontend/blocks/form-search-all-service/style_2.blade.php ENDPATH**/ ?>