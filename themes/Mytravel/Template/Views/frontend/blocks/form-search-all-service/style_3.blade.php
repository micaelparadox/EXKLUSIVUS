<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2" style="background-image: none !important;">
    <video autoplay muted loop poster="{{$bg_image_url}}">
